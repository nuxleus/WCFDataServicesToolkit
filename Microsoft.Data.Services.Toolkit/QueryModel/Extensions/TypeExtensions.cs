namespace Microsoft.Data.Services.Toolkit.QueryModel
{
    ...
    {
        internal static Type TypeOrElementType(this Type type)
        {
            if (type.IsArray)
        ...
        internal static IDictionary<string, PropertyDetails> GetPropertyDetails(this IEnumerable<PropertyInfo> properties)
        {
        ...
        internal static IDictionary<string, PropertyDetails> GetPropertyDetails(this Type type)
        {
